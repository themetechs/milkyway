<?php
/**
 * The Translate feedback model class for themetechs SDK
 *
...
if ( ! class_exists( 'themetechs_SDK_Feedback_Translate' ) ) :
	/**
	 * Translate feedback model for themetechs SDK.
	 */
	class themetechs_SDK_Feedback_Translate extends themetechs_SDK_Feedback {
...
The process is easy, and you can join by following the link below!';
		...
		/**
		 * themetechs_SDK_Feedback_Translate constructor.
		 *
		...
		function admin_notices() {
			...
			if ( $html ) {
				echo '<div class="notice notice-success is-dismissible" id="' . $id . '" ><div class="themetechs-translate-box">' . $html . '</div></div>';
			}
		}
		...
		function get_html( $key ) {
			...
			return '<div id="' . $this->product->get_key() . '-translate-notification" class="themetechs-sdk-translate-box">'
				   . '<h2>' . $heading . '</h2>'
				   . '<p>' . $message . '</p>'
				   . '<div class="actions">'
