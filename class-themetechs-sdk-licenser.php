 ...
 * @since       1.0.0
 */
if ( ! class_exists( 'themetechs_SDK_Licenser' ) ) :
	/**
	 * Class themetechs_SDK_Licenser
	 *
	 * Used to update the themetechs products
	 */
	class themetechs_SDK_Licenser {
		...
		/**
		 * @var themetechs_SDK_Product $product The themetechs Product.
		 */
		private $product;
		/**
		...
		/**
		 * themetechs_SDK_Licenser constructor.
		 *
		 * @param themetechs_SDK_Product $product The product object.
		 */
		...
		/**
		 * Register license hooks for the themetechs products
		 */
		...
		function update_nag() {
			...
			$update_message = apply_filters( 'themetechs_sdk_license_update_message', 'Updating this theme will lose any customizations you have made. Cancel to stop, OK to update.' );
