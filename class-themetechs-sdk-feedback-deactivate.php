<?php
/**
 * The deactivate feedback model class for themetechs SDK
 *
...
if ( ! class_exists( 'themetechs_SDK_Feedback_Deactivate' ) ) :
	/**
	 * Deactivate feedback model for themetechs SDK.
	 */
	class themetechs_SDK_Feedback_Deactivate extends themetechs_SDK_Feedback {
		...
		function load_resources() {
			...
			echo '<div id="' . $id . '" style="display:none;" class="themetechs-deactivate-box">' . $this->get_html( $this->product->get_type(), $this->product->get_key() ) . '</div>';
		}
