<?php
/**
 * The review feedback model class for themetechs SDK
 *
...
if ( ! class_exists( 'themetechs_SDK_Feedback_Review' ) ) :
	/**
	 * Deactivate feedback model for themetechs SDK.
	 */
	class themetechs_SDK_Feedback_Review extends themetechs_SDK_Feedback {
		...
		/**
		 * themetechs_SDK_Feedback_Deactivate constructor.
		 *
		 * @param themetechs_SDK_Product $product_object The product object.
		 */
		...
		function admin_notices() {
			...
			echo '<div class="notice notice-success is-dismissible" id="' . $id . '" ><div class="themetechs-review-box">' . $this->get_html( $this->product->get_key() ) . '</div></div>';
		}
		...
		function get_html( $key ) {
			...
			return '<div id="' . $this->product->get_key() . '-review-notification" class="themetechs-sdk-review-box">'
				   . '<p>' . $heading . '</p>'
				   . ( $msg ? '<p>' . $msg . '</p>' : '' )
				   . '<div class="actions">'
